...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--fineSize1', type=int, default=256, help='then crop to this size')
		self.parser.add_argument('--fineSize2', type=int, default=128, help='then resize to this size')
		self.parser.add_argument('--fineSize3', type=int, default=64, help='then resize to this size')
		...
		self.parser.add_argument('--checkpoints_dir', type=str, default='/home/fengyutong/code/DeblurNet/DeblurSrc/checkpoints', help='models are saved here')
